<!-- { section: "d553c3e2-fd50-4223-9ca3-f4068018240f", x: -1032, y: -24} -->
...
card Message_1, "Message_1", code_generator: "REPLY_BUTTON_TEXT" do
  ref_Message_1 =
    buttons(["Tell me more!"]) do
      text("Hello! 👋 Let's start the day with a mini test: How is your conversation thermometer?")
    end
...
<!-- { section: "e34aff25-2c0d-461c-8452-770da23b295e", x: -384, y: 144} -->

```stack
card Branch_c99dc9, "Branch_c99dc9", code_generator: "CONDITIONALS" do
  then(
...
card RunStack_b8be21, "RunStack_b8be21", code_generator: "RUN_STACK" do
  run_stack("03bfbcbf-9a2d-4a6f-a7b7-dc9641cfbeef")
end
...
<!-- { section: "1540c897-0ecb-4545-b17b-eb581b689b6c", x: -288, y: 408} -->
...
<!-- { section: "be95aafb-4d02-4b48-935d-358c2cabd053", x: -648, y: -192} -->
